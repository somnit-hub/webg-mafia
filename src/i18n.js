...
const COPY = {
  it: {
    ...
    'Ім’я *': 'Nome *',
    'Нікнейм *': 'Soprannome *',
    'Використовуватиметься як основне ім’я гравця під час гри.': 'Verrà usato come nome principale del giocatore durante la partita.',
    'Вкажіть нікнейм для гри': 'Inserisci un soprannome per la partita',
  ...
  en: {
    ...
    'Ім’я *': 'Name *',
    'Нікнейм *': 'Nickname *',
    'Використовуватиметься як основне ім’я гравця під час гри.': 'This will be used as the player’s primary name during the game.',
    'Вкажіть нікнейм для гри': 'Enter a nickname for the game',
  ...
  fr: {
    ...
    'Ім’я *': 'Nom *',
    'Нікнейм *': 'Pseudo *',
    'Використовуватиметься як основне ім’я гравця під час гри.': 'Il sera utilisé comme nom principal du joueur pendant la partie.',
    'Вкажіть нікнейм для гри': 'Saisissez un pseudo pour la partie',
