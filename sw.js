...
const APP_SHELL = [
  ...
  './src/app.js?v=155', './src/auth.js', './src/pwa.js', './src/cloud-profiles.js', './src/cloud-games.js?v=154', './src/game-feedback.js', './src/game-engine.js', './src/order-service.js', './src/player-links.js', './src/timer.js', './src/lineup.js', './src/guest-names.js', './src/i18n.js', './src/firebase-config.js', './src/db.js', './src/google-sync.js', './src/enjoy.js'
];
const FIREBASE_SDK = [
