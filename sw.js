...
const APP_SHELL = [
  ...
  './src/app.js?v=180', './src/auth.js', './src/pwa.js', './src/cloud-profiles.js', './src/cloud-games.js?v=158', './src/cloud-venues.js', './src/venue-directory.js', './src/game-music.js', './src/game-feedback.js', './src/player-ranking.js', './src/game-chat.js?v=2', './src/telegram-profile.js', './src/game-engine.js', './src/order-service.js', './src/player-directory.js', './src/player-links.js', './src/timer.js', './src/lineup.js', './src/guest-names.js', './src/i18n.js', './src/firebase-config.js', './src/db.js', './src/google-sync.js', './src/enjoy.js'
];
const FIREBASE_SDK = [
