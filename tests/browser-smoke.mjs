...
const randomTable = await evaluate(`({
  ...
  diceIcon: Boolean(document.querySelector('[data-action="random-table"] .button-dice-icon')),
...
verify(randomTable.selected === 10 && randomTable.unique === 10 && randomTable.venue.includes('Кав’ярня Enjoy') && randomTable.title.startsWith('Мафія в Enjoy') && randomTable.reroll && randomTable.diceIcon && randomTable.shuffleIcon && randomTable.iconsDecorative && randomTable.nicknameFirstOption === 'Тестовий Нік · Тестова Гравчиня' && queuedTable.followsSelection && preferredSeatName === 'Тестовий Нік', 'nickname-first queued table with random and shuffle icons');
